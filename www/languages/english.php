...
$LNG['ttl_like_email'] = '%s liked your post';
$LNG['like_email'] = 'Hello <strong>%s</strong>,<br /><br /><strong><a href="%s">%s</a></strong> liked your <strong><a href="%s">post.</a></strong>
<br /><br /><span style="color: #aaa;">This message was sent automatically, if you don\'t want to receive these type of emails from <strong>%s</strong> in the future, please <a href="%s">Unsubscribe</a>.</span>';
...
$LNG['welcome_timeline'] = 'All your posts will be displayed on this page, start by sharing your thoughts.';
...
// MESSAGES / CHAT //
$LNG['lonely_here'] = 'Oops! You don\'t seem to have anyone on your list yet. Start by adding new friends!';
...
$LNG['start_conversation'] = 'Start a conversation by choosing a person from your friends list.';
...
$LNG['user_desc_general'] = 'Change account settings.';
...
$LNG['sub_verified'] = 'This user is a verified course instructor or administrator';
...
$LNG['admin_ttl_title'] = 'Site\'s Title';
...
$LNG['admin_sub_password'] = 'Leave this field empty if you don\'t want to change your password';
...
$LNG['new_like_notification'] = '<strong><a href="%s">%s</a></strong> liked your <strong><a href="%s">post</a></strong>';
$LNG['new_comment_notification'] = '<strong><a href="%s">%s</a></strong> commented on your <strong><a href="%s">post</a></strong>';
$LNG['new_shared_notification'] = '<strong><a href="%s">%s</a></strong> shared your <strong><a href="%s">post</a></strong>';
...
$LNG['search_in_friends'] = 'Search for friends to chat with...';
$LNG['follows'] = 'Follows';
